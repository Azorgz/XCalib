...
from XCalib.precomputation.precomputation import Precomputation
from . import get_dataset
from .types import collate_batch_fn
from ..config.XCalib import XCalibCfg
...
def get_dataModule(device: torch.device, cfg) -> DataModule | list:
    ...
    if isinstance(dataset, list):
        return [DataModule(device, cfg, dataset[i]) for i in range(len(dataset))]
    else:
        return DataModule(device, cfg, dataset)
