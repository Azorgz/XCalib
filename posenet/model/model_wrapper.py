...
from ThirdParty.ImagesCameras import CameraSetup
...
class ModelWrapper(LightningModule):
    def __init__(
        ...
        self.lr = self.cfg.lr
        self.model = Model(cfg.model, cameras, sequential=sequential)
    ...
    def training_step(self, batch):
        ...
        if self.last_batch is not None:
            if not all(self.last_batch.indices == batch.indices):
        ...
        model_output = self.model(self.last_batch, self.global_step, new_batch)
