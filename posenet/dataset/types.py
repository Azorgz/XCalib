...
from ThirdParty.ImagesCameras.Cameras import Cameras
from ..feature import OBJECTS
...
class Batch(Manipulable):
    ...
    # features: Float[Tensor, "batch frame features height width"] | None = None
    objects: list[list[OBJECTS.values()]] | None = None
